...
with detection_graph.as_default():
  with tf.Session(graph=detection_graph) as sess:
    while True:
      ...
      screen = cv2.resize(numpy.array(sct.grab({'top': 30, 'left': 0, 'width': 640, 'height': 400})), (800, 450))
      image_np_scr = cv2.cvtColor(screen, cv2.COLOR_BGR2RGB)
      ## Convert to RGB
      image_np = cv2.cvtColor(image_np_scr, cv2.COLOR_BGR2RGB)
      ...
      cv2.imshow('object detection', cv2.resize(image_np, (640, 400)))
