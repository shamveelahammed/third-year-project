...
# Use laptop's webcam for video input
...
### For Keyboard input and exiting the program
      cv2.imshow('Navigation Aid', cv2.resize(image_np, (800, 600)))
